# configs/experiments/itransformer_hybrid.py
"""
...
python evaluate.py \
  --config configs/experiments/itransformer_hybrid.py \
  --checkpoint output/itransformer_hybrid/models/final.pth \
  --mode test
...
# rm -r output/itransformer_hybrid; rm -rf data_cache/*
"""
...
cfg.loss.type_hybrid     = "sharpe_hybrid"
